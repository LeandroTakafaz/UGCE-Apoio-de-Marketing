...
$(document).ready(function() {
    var checkboxes = ["Eventos", "Coffee", "Jornada", "Logo", "Estrategia", "Imprensa", "Grafica", "Cobertura"];
    var campos = ["eventos", "coffee", "jornada", "logo", "estrategia", "imprensa", "grafica", "cobertura"];
